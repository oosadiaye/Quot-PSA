        ...
        <div style={{ background: 'var(--color-surface-hover)', minHeight: '100vh' }}>
            ...
            <main style={{ marginLeft: '260px', padding: '32px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <div>
                        <h1 style={{ fontSize: '24px', fontWeight: 800, color: 'var(--color-text)', margin: 0 }}>Fund Performance Report</h1>
                        <p style={{ color: 'var(--color-text-muted)', fontSize: '14px', margin: '4px 0 0' }}>Budget vs Actual by Fund Source — Utilization Analysis</p>
                    </div>
                                    ...
                                    {filteredRows.map((row, idx) => {
                                        ...
                                        return (
                                            <tr key={idx} style={{ borderBottom: '1px solid var(--color-border-light)' }}>
                                                ...
                                                <td style={{ padding: '10px 14px', fontSize: '13px', textAlign: 'right', fontWeight: 700, color: 'var(--color-text-muted)' }}>{Number(row.pct_of_total ?? 0).toFixed(1)}%</td>
                                            </tr>
                                        );
                                    })}
                                </tbody>
