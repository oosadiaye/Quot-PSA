        ...
        <div style={{ background: '#f1f5f9', minHeight: '100vh' }}>
            ...
            <main style={{ marginLeft: '260px', padding: '32px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <div>
                        <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#1e293b', margin: 0 }}>Geographic Distribution Performance Report</h1>
                        <p style={{ color: '#64748b', fontSize: '14px', margin: '4px 0 0' }}>Budget vs Actual Expenditure by Geographic Location — Utilization Analysis</p>
                ...
                {isLoading ? (
                    ...
                    <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #e8ecf1', overflow: 'hidden' }}>
                        ...
                        {(!data.rows || data.rows.length === 0) && (
                            <div style={{ textAlign: 'center', padding: '40px', color: '#94a3b8' }}>No geographic distribution data for this fiscal year.</div>
                        )}
                    </div>
                ) : null}
            </main>
