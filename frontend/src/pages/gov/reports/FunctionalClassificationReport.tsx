        ...
        <div style={{ background: 'var(--color-surface-hover)', minHeight: '100vh' }}>
            ...
            <main style={{ marginLeft: '260px', padding: '32px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <div>
                        <h1 style={{ fontSize: '24px', fontWeight: 800, color: 'var(--color-text)', margin: 0 }}>Functional Classification Performance Report (COFOG)</h1>
                        <p style={{ color: 'var(--color-text-muted)', fontSize: '14px', margin: '4px 0 0' }}>Budget vs Actual by COFOG Function — Utilization Analysis</p>
                    </div>
                ...
                {isLoading ? (
                    ...
                    <div style={{ background: 'var(--color-surface)', borderRadius: '12px', border: '1px solid var(--color-border)', overflow: 'hidden' }}>
                        ...
                        {(!data.rows || data.rows.length === 0) && (
                            <div style={{ textAlign: 'center', padding: '40px', color: 'var(--color-text-subtle)' }}>No functional classification data for this fiscal year.</div>
                        )}
                    </div>
                ) : null}
            </main>
