        ...
        <AccountingLayout>
            <form onSubmit={handleSubmit}>
                <PageHeader
                    ...
                    subtitle="Create a purchase requisition with MDA and dimension tagging."
                    ...
                    <div style={{ maxWidth: 520, margin: '2rem auto', textAlign: 'center' }}>
                        <div className="card" style={{ padding: '2.5rem 2rem' }}>
                            ...
                            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: '1.5rem' }}>
                                Your purchase requisition has been saved as Draft.
                            </p>
                            <div style={{
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={thStyle}>Description / Item</th>
                                                    ...
                                                    <td style={{ padding: '0.35rem' }}>
                                                        {line.line_type === 'item' ? (
                                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                                                                ...
                                                                />
                                                                <input style={{ ...inputStyle, fontSize: 'var(--text-xs)', padding: '0.3rem 0.5rem' }}
