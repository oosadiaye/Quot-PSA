"""
Django settings for dtsg_erp project.
...
WSGI_APPLICATION = 'dtsg_erp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'dtsg_erp'),
...
if os.getenv('DB_REPLICA_HOST'):
    DATABASES['replica'] = {
        'ENGINE': 'django_tenants.postgresql_backend',
        'NAME': os.getenv('DB_REPLICA_NAME', os.getenv('DB_NAME', 'dtsg_erp')),
...
DATABASE_ROUTERS = (
    'dtsg_erp.db_router.TenantAwareReadReplicaRouter',  # Phase 3: read replica routing
...
# =============================================================================
# EMAIL (overridden by SuperAdminSettings if SMTP is configured)
# =============================================================================
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@dtsg.test')
SUPPORT_EMAIL = os.getenv('SUPPORT_EMAIL', 'support@dtsg.test')
